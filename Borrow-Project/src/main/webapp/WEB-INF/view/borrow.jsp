	...
	<div class="container text-center">
		...
		<form class="form-horizontal" method="POST" action="borrow-request">
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<input type="number" min="1000" max="100000" step="1000" class="form-control" name="requestedAmount"
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<input type="number" min="3" max="36" step="3" class="form-control" name="period"
						value="${borrow.period}" />
				</div>
			</div>
			<div class="form-group">
